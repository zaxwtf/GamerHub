...
function Home(){
    return(
        <div className="flex w-[99%] flex-col items-center ">
            ...
            <h1 className="text-4xl font-black text-center">¡Bienvenido a GamerHub!</h1>
            <h2 className="text-3xl my-8 font-black mx-5 ">¡Todos tus Videojuegos favoritos al alcance de un click!</h2>
            <LoadVideogames/>
